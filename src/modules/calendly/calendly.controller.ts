...
export class CalendlyController {
  ...
  @Get('mentee/schedules')
  @UseGuards(AuthGuard())
  async fetchMenteeSchedules(@LoggedEntity() user: UserEntity) {
    return this.fetchSchedulesService.getMenteeSchedules(user);
  }
  ...
  async createMentorInvitee(
    ...
    @LoggedEntity() invitee: UserEntity,
  ) {
